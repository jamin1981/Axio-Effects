...
const App = () => {
  ...
  const TRANSITION_SECTION_ID = 'Transition Effects';
  const navItems = [...categories, TRANSITION_SECTION_ID];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-indigo-500/30">
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-20 relative">
            ...
            >
                ...
                <p className="text-slate-400 text-lg max-w-2xl mx-auto leading-relaxed">
                  Collection of effects to explore the art of the possible, the effects are not meant to be final representations or suggestions of what to include.
                </p>
            </motion.div>
        </div>
            ...
            {categories.map((cat) => {
                ...
                return (
                    <section key={cat} id={cat} className="scroll-mt-40">
                         ...
                         >
                            <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent whitespace-nowrap">
                                {cat}
                            </h2>
        ...
        <section id={TRANSITION_SECTION_ID} className="mb-24 pt-12 border-t border-slate-800 scroll-mt-40">
           <motion.div 
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true, margin: "-100px" }}
